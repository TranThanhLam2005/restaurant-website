    ...
    <Card className="flex flex-row gap-14 p-4 md:p-10">
      ...
      <div className="flex flex-col flex-1 gap-2 md:gap-6">
        ...
        <CardContent className="font-light leading-relaxed text-muted-foreground text-center md:text-left">
          ...
          prices. Quality, freshness, and friendly service are key values of the
          brand. Texas Roadhouse aims to deliver a fun and satisfying dining
