...
export default function AboutSection() {
  return (
    ...
    >
      ...
      >
        <h2 className="font-bold text-primary mt-10">About Us</h2>
      ...
      <div className="flex flex-col md:flex-row gap-2 items-center">
        ...
        <motion.div className="w-full md:w-1/2" variants={fadeInRightVariants}>
          <Card>
            <CardHeader>
              <CardTitle className="text-3xl font-serif font-bold tracking-wider">
                OPENING HOURS
              </CardTitle>
            </CardHeader>
            ...
            <CardContent className="space-y-4">
              {["Monday - Thursday", "Friday", "Saturday - Sunday"].map(
                (day, index) => (
                  ...
                  >
                    <div className="font-serif font-medium">{day}</div>
